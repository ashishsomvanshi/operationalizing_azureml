...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer n3xmoCR8fcATO4mPwYvLLhlW9biifUhd' http://23ee020f-ec49-4441-8218-19d8afe69439.eastus.azurecontainer.io/score
